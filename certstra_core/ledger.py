#!/usr/bin/env python3
"""Hash-chain certification ledger (deterministic).

Same discipline as Attestra/Clearstra: canonical JSON, record_hash excludes wall-time
metadata (time-independent), tamper-evident. Records certify/stage/verify events.
...
def append_cert(ledger_path, result, pack, kind, now="", subject=""):
